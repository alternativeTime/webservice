 ...
 * 
 */
public class IdListRESTServiceTest {
    /**
   ...
   // private static final String XML_PROPERTY = "http://localhost:8080/cross-database-search/rest/substructure/xml";
    ...
    public static void beforeClass() {
    	...
    	IdListRESTServiceTest.XMLDETAIL_URL = "http://localhost:10000/cross-database-search/rest/idList/xml";//System.getProperty(SubstructureRESTServiceTest.XML_PROPERTY);
    	IdListRESTServiceTest.JSON_URL = System.getProperty(IdListRESTServiceTest.JSON_PROPERTY);
    }
...
//                this.runRequest(SubstructureRESTServiceTest.XML_URL, MediaType.APPLICATION_XML_TYPE));
        assertEquals("XML Response", IdListRESTServiceTest.XML_RESPONSE,
                this.runRequest(IdListRESTServiceTest.XMLDETAIL_URL, MediaType.APPLICATION_XML_TYPE));
    }
...
//    	aSubstructureRESTServiceTest.runRequest("http://localhost:8080/cross-database-search/rest/substructure/xml", MediaType.APPLICATION_XML_TYPE);
    ...
    private String runRequest(String url, MediaType mediaType) {
        ...
        try {
            ...
            IdListRequest aIdListRequest= new IdListRequest();
           ...
           // aStructure = new Structure();
            aStructure.setId("30");
            aList.add(aStructure);
            aIdListRequest.setStructures(aList);

            request.body(MediaType.APPLICATION_XML_TYPE, aIdListRequest);
     ...
     * @param mediaType The mediatype of the RESTful service
     */
    private String runRequest2(String url, MediaType mediaType) {
        String result = null;
     ...
     * @param mediaType The mediatype of the RESTful service
     */
    private String runRequest3(String url, MediaType mediaType) {
        String result = null;
